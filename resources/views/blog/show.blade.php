...
@section('header')
     <!-- Header -->
    <header class="header text-white h-fullscreen pb-80" style="background-image: url({{ asset('storage/'.$post->image)}}) !important;" data-overlay="9">
            ...
            <div class="row">
                <div class="gap-xy-2 mt-6">
                    @foreach ($post->tags as $tag)
                        <a class="badge badge-pill badge-secondary" href="{{ route('blog.tag', $tag)}}">{{ $tag->name }}</a>
                    @endforeach
                </div>
            </div>
              ...
              <div class="col-lg-8 mx-auto">
                ...
                <script>
                    ...
                    *  LEARN WHY DEFINING THESE VARIABLES IS IMPORTANT: https://disqus.com/admin/universalcode/#configuration-variables    */
                    ...
                    s.src = 'https://saas-blog-tb8nryvtej.disqus.com/embed.js';
